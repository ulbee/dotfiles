...
## Работа над проектом внутри arcadia

Обязательные правила при работе над проектом внутри директории '~/arcadia':

 - для поиска по файлам и вложенным директориям используй только arc mcp
 - в первую очередь ищи по файлам с расширениями js, ts, tsx, css, scss, json, md
